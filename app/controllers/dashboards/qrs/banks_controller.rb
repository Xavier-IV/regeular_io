...
class Dashboards::Qrs::BanksController < ApplicationController
  ...
  def new
    return redirect_to edit_dashboards_qrs_bank_path if current_client.business.business_bank.present?
  ...
  def edit
    return redirect_to new_dashboards_qrs_bank_path if current_client.business.business_bank.blank?
