...
class Dashboards::Rewards::DiscountsController < ApplicationController
  ...
  def show
    redirect_to edit_dashboards_reward_discount_path
  end
  ...
  def edit
    ...
    redirect_to new_dashboards_reward_discount_path if @reward.blank?
  end
